...
import org.vincent.dao.model.TbUserExample.Criteria;
import org.vincent.dao.model.TbUserExample.Criterion;
...
public class TbUserSqlProvider {
    ...
    public String insertSelective(TbUser record) {
        ...
        if (record.getCtm() != null) {
            sql.VALUES("ctm", "#{ctm,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCtm() != null) {
            sql.SET("ctm = #{record.ctm,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(TbUser record) {
        ...
        if (record.getCtm() != null) {
            sql.SET("ctm = #{ctm,jdbcType=TIMESTAMP}");
        }
