...
import org.vincent.dao.model.BatchJobExecutionExample.Criteria;
import org.vincent.dao.model.BatchJobExecutionExample.Criterion;
import org.vincent.dao.model.BatchJobExecutionExample;

public class BatchJobExecutionSqlProvider {

    public String countByExample(BatchJobExecutionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("BATCH_JOB_EXECUTION");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(BatchJobExecutionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("BATCH_JOB_EXECUTION");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(BatchJobExecution record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("BATCH_JOB_EXECUTION");
        ...
        if (record.getJobConfigurationLocation() != null) {
            sql.VALUES("JOB_CONFIGURATION_LOCATION", "#{jobConfigurationLocation,jdbcType=VARCHAR}");
        }
        
        return sql.toString();
    }

    public String selectByExample(BatchJobExecutionExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("JOB_CONFIGURATION_LOCATION");
        sql.FROM("BATCH_JOB_EXECUTION");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BatchJobExecution record = (BatchJobExecution) parameter.get("record");
        BatchJobExecutionExample example = (BatchJobExecutionExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("BATCH_JOB_EXECUTION");
        ...
        if (record.getJobConfigurationLocation() != null) {
            sql.SET("JOB_CONFIGURATION_LOCATION = #{record.jobConfigurationLocation,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(BatchJobExecution record) {
        SQL sql = new SQL();
        sql.UPDATE("BATCH_JOB_EXECUTION");
        ...
        if (record.getJobInstanceId() != null) {
            sql.SET("JOB_INSTANCE_ID = #{jobInstanceId,jdbcType=BIGINT}");
        }
        ...
        if (record.getJobConfigurationLocation() != null) {
            sql.SET("JOB_CONFIGURATION_LOCATION = #{jobConfigurationLocation,jdbcType=VARCHAR}");
        }
        
        sql.WHERE("JOB_EXECUTION_ID = #{jobExecutionId,jdbcType=BIGINT}");
        
        return sql.toString();
    }

    protected void applyWhere(SQL sql, BatchJobExecutionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
