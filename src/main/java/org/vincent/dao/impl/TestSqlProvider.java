...
import org.vincent.dao.model.TestExample.Criteria;
import org.vincent.dao.model.TestExample.Criterion;
...
public class TestSqlProvider {
    ...
    public String insertSelective(Test record) {
        ...
        if (record.getBl() != null) {
            sql.VALUES("bl", "#{bl,jdbcType=BIT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getBl() != null) {
            sql.SET("bl = #{record.bl,jdbcType=BIT}");
        }
